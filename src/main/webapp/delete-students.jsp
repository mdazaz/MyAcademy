...
function deleteSelectedRow(id){
	...
	if (result) {
		window.location.href="delete-student-submit.jsp?id="+id+"&operation=DEL";
	}
				...
				<tbody>
					...
					for(Students stud: listOfStudents){
							if(!(stud.getName().equals(""))){
								...
								out.print("<td><input type='button' class='btn btn-danger' value='Delete' name='delete'onclick='deleteSelectedRow("+stud.getId()+")'/></td>");
								out.print("</tr>");
							}
